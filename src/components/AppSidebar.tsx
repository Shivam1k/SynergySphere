          ...
          {!collapsed && (
            <div className="mt-2">
              {/* <Button
                ...
                className={`w-full justify-start text-muted-foreground hover:text-foreground ${currentView === "profile-settings" ? "bg-accent" : ""}`}
              >
              ...
              {/* <Button
                ...
                className={`w-full justify-start text-muted-foreground hover:text-foreground ${currentView === "user-settings" ? "bg-accent" : ""}`}
              >
